"""
Mock LLM — offline, deterministic-ish responses for local dev / CI.
Swap out for a real provider by exporting OPENAI_API_KEY and calling
the real SDK inside `ask()`.
"""
import random
import time
...
def ask_stream(question: str):
    """Mock streaming response — yield one token at a time."""
